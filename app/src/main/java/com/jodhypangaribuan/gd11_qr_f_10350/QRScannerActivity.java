package com.jodhypangaribuan.gd11_qr_f_10350;
...
import com.jodhypangaribuan.gd11_qr_f_10350.databinding.ActivityQrscannerBinding;
...
public class QRScannerActivity extends AppCompatActivity {
    ...
    private void setupScanner() {
        ...
        codeScanner.setDecodeCallback(new DecodeCallback() {
            @Override public void onDecoded(@NonNull Result result) {
                Intent intent = new Intent();
